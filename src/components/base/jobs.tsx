  ...
  return (
    ...
    >
      ...
      <div className="mt-12 flex justify-center gap-6 md:hidden">
        <div className="flex h-160 w-0.5 flex-col items-center justify-between overflow-visible bg-linear-to-b from-[#555555] to-[#0A0A0A] py-6">
          <span className="bg-primary h-3 w-3 rounded-full"></span>
          <span className="bg-primary mb-46 h-3 w-3 rounded-full"></span>
        </div>
