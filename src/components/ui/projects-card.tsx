...
export const ProjectsCard = ({
  ...
  return (
    <>
      ...
      <SpotlightCard className="border-muted-foreground hover:border-primary flex h-75 flex-col justify-between gap-4 rounded-xl border transition-all duration-300">
